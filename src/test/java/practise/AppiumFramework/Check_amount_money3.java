...
public class Check_amount_money3  extends Start {
	@BeforeTest
	...
	@Test(dataProvider="InputData",dataProviderClass=DataProviderq.class)
public void totalValudation(String input) throws IOException, InterruptedException {
		service=startServer();
